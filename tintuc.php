<div id="tintuc">
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($con,"SELECT * FROM tintuc ORDER by matt DESC  LIMIT $from, $max_results"); 
...
<div id="phantrang_sp">
	...
	<?php
			...
			$total_results = mysqli_result(mysql_query("SELECT COUNT(*) as Num FROM tintuc"),0);  
